    ...
    <div id="contact" className="pt-16 min-h-screen ">
      ...
      <div className="container mx-auto p-4 w-11/12">
        <div className="title text-center mb-8">
          <h1 className="text-4xl font-bold mb-3 text-purple-700">Contact Us</h1>
        ...
        <div className="form grid grid-cols-1 gap-6 md:grid-cols-2">
          <div className="firstname">
            <label htmlFor="firstname" className="block text-purple-700 font-medium mb-2">First name</label>
            <input
              type="text"
              name="firstname"
              id="firstname"
          ...
          <div className="lastname">
            <label htmlFor="lastname" className="block text-purple-700 font-medium mb-2">Last name</label>
            <input
              type="text"
              name="lastname"
              id="lastname"
          ...
          <div className="email col-span-2">
            <label htmlFor="email" className="block text-purple-700 font-medium mb-2">Email Address</label>
            <input
              type="email"
              name="email"
              id="email"
          ...
          <div className="subject col-span-2">
            <label htmlFor="subject" className="block text-purple-700 font-medium mb-2">Subject</label>
            <input
              type="text"
              name="subject"
              id="subject"
          ...
          <div className="message col-span-2">
            <label htmlFor="message" className="block text-purple-700 font-medium mb-2">Message</label>
            <textarea
              name="message"
              id="message"
