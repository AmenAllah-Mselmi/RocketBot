...
import image1 from "../assets/carousel/suiveur1.jpg";
import image2 from "../assets/carousel/suiveur2.jpg";
import image3 from "../assets/carousel/suiveur3.jpg";
import image4 from "../assets/carousel/junior.jpg";
const AccueilCarousel = () => {
  ...
  return (
    <div className="w-screen overflow-hidden mt-16 flex justify-center items-center flex-col">
      <h1 className="text-3xl font-semibold text-purple-700 mb-3 font-mono">Our winners</h1>
